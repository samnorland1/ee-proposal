        ...
        <div className="space-y-4">
          ...
          {selected && (
            <div className="bg-white border border-gray-200 rounded-xl p-5">
              ...
              <h3 className="text-sm font-semibold text-gray-900 mb-3 mt-5">Extra Context <span className="font-normal text-gray-400">(optional)</span></h3>
              <textarea
                value={extraContext}
                onChange={(e) => setExtraContext(e.target.value)}
                placeholder="Any additional context to include beyond the meeting notes..."
                rows={3}
